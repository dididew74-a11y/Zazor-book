...
* *Оптика Зазора: **преквалиа** — напряжение без формы, напряжение превышающее способность к удержанию маски.*
...
* *Оптика Зазора: **Детерминанта** — защитная фиксация, которая при затягивании препятствует преображению. Происходит *блокировка кенозиса* — отказ удерживаться в неопределённости до рождения нового смысла.*
